...
const phef = { textDecoration: "none", color: "white", fontSize: "12px", onMouseOver: { color: "#ECEDCE" } };
        ...
        return (
            ...
            <div>
                <div style={{ backgroundColor: "white" }}>
                    <h2 style={{ margin: " 0  0px", color: "black" }}>Meet our Awesome Fleet</h2>
                    <br />
                ...
                <div style={{ backgroundColor: "black", width: "100%", height: "2px", marginBottom: "15px" }}> </div>
                <div style={{ height: "auto", width: "auto", backgroundColor: "#EDEDED", paddingLeft: "20px", paddingRight: "20px", paddingBottom: "40px" }}><img style={{ height: "auto", width: "100%", paddingRight: "40px" }} src="https://www.olacabs.com/webstatic/img/ola-booking.png"></img></div>
                ...
                <div style={{ height: "90px", width: "100%", marginLeft: "5px", }}>
                    <div> <img style={{ height: "40px", width: "70px", marginTop: "10px" }} src="https://www.olacabs.com/webstatic/img/playstore.png" alt=""></img>
                        <img style={{ height: "40px", width: "70px", marginTop: "10px", paddingLeft: "20px" }} src="https://www.olacabs.com/webstatic/img/appstore.png" alt=""></img>
                        <img style={{ height: "40px", width: "70px", marginTop: "10px", paddingLeft: "20px" }} src="https://www.olacabs.com/webstatic/img/windowstore.png" alt=""></img>
                    </div>
                    ...
                    <div style={{ height: "auto", width: "100%", backgroundColor: "white" }}>
                        <div style={{ marginLeft: "-10px", marginRight: "-10px", marginBottom: "-10px", }}>
                            ...
                            <div style={{ backgroundColor: "#3f3f3f", color: "white", float: "left", height: "auto", width: "100%", paddingTop: "20px", paddingBottom: "20px" }}>
                                <center><h3> Top Visited Cities</h3></center>
                            </div>
