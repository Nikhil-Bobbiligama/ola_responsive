...
class Threedesk extends Component {


    render() {

        return (
            <div style={{ height: "auto", backgroundColor: "white", marginTop: "80px", width: "100%" }}>
                <div></div>
                ...
                <div style={{ height: "auto", width: "100%", display: "inlineBlock" }}>
                    <div style={{ height: "600px", width: "30%", backgroundColor: "white", float: "left" }}>
                        {/* <div style={{}}>
                            <img style={{ width: "100%", height: "220px", borderTopLeftRadius: "5px", borderTopRightRadius: "5px" }} src="https://cms-web.olacabs.com/00000000356.jpg"></img>
                            <div style={{ float: "right", zIndex: "2", backgroundColor: "#CCE500", marginTop: "-10px", borderRadius: "50%", height: "85px", width: "85px" }}> <img style={{ zIndex: "3", float: "right", height: "85px", width: "85px" }} src="https://www.olacabs.com/webstatic/img/service-type/ola-prime-sedan-active.svg"></img>
                            </div>
                        ...
                        <div style={{ height: " auto", backgroundColor: "white", borderRadius: "5px", border: " 1px solid grey  ", margin: "10px" }}>
                            <div style={{ width: "100%" }}>
                                ...
                                <div style={{ zIndex: "1", position: "absolute", marginLeft: "20%", marginTop: "150px", height: "85px", borderRadius: "50%", width: "85px", backgroundColor: "#CCE500" }}><img style={{ height: "80px", width: "80px" }} src="https://www.olacabs.com/webstatic/img/service-type/ola-prime-sedan-active.svg"></img></div>
                                <img style={{ zIndex: "1", width: "100%", height: "200px", borderTopLeftRadius: "5px", borderTopRightRadius: "5px" }} src="https://cms-web.olacabs.com/00000000356.jpg"></img>
                                {/* <div style={overlay}>
                                    <div class="circleBase type1">
                                        <div style={{ top: "2px", position: "relative", float: "left", paddingBottom: "-60px", paddingRight: "-20px" }}> <img src="https://www.olacabs.com/webstatic/img/service-type/ola-prime-sedan-active.svg"></img>   </div>
                                    </div></div>  */}
                                <div>
                                    <div style={{ top: "-60px", color: "black" }}> <h3>CITY TAXI </h3> <br />   <br /> <br />
                                        <div style={{ color: "rgba(0, 0, 0, 0.6)", top: "-100px", margin: "20px", marginTop: "-50px" }}>     The perfect way to get through your everyday travel needs. City taxis are available 24/7 and you can book and travel in an instant. With rides starting from as low as Rs. 6/km, you can choose from a wide range of options! You can also opt to do your bit for the environment with Ola Share!</div>
                    ...
                    <div style={{ height: "600px", width: "30%", marginLeft: "1%", backgroundColor: "white", float: "left" }}>
                        {/* <div style={{ width: "100%" }}>
                            ...
                            <div style={overlay}>
                                <div class="circleBase type1">
                                    <div style={{ top: "2px", position: "relative", paddingBottom: "-60px", paddingRight: "-90px", marginTop: "-120px" }}> <img src="https://www.olacabs.com/webstatic/img/service-type/ola-outstation-active.svg"></img>   </div>
                                </div></div>  <div>
                        ...
                        <div style={{ height: " auto", backgroundColor: "white", borderRadius: "5px", border: " 1px solid grey  ", margin: "10px" }}>
                            ...
                            <div style={{ width: "100%" }}>
                                <div style={{ zIndex: "1", position: "absolute", marginLeft: "20%", marginTop: "150px", height: "85px", borderRadius: "50%", width: "85px", backgroundColor: "#CCE500" }}><img style={{ height: "80px", width: "80px" }} src="https://www.olacabs.com/webstatic/img/service-type/ola-outstation-active.svg"></img></div>
                    ...
                    <div style={{ height: "600px", float: "left", width: "30%", marginLeft: "1%", backgroundColor: "white" }}>
                        <div style={{ height: " auto", backgroundColor: "white", borderRadius: "5px", border: " 1px solid grey  ", margin: "10px" }}>

                            <div style={{ width: "100%" }}>
                                <div style={{ zIndex: "1", position: "absolute", marginLeft: "20%", marginTop: "150px", height: "85px", borderRadius: "50%", width: "85px", backgroundColor: "#CCE500" }}><img style={{ height: "80px", width: "80px" }} src="https://www.olacabs.com/webstatic/img/service-type/ola-prime-suv-active.svg"></img></div>
