    ...
    render() {
        ...
        return (
            <div style={{ height: "auto", backgroundColor: "white", marginTop: "80px", width: "100%" }}>
                ...
                <div style={{ height: "auto", width: "100%", display: "inlineBlock" }} className = "Row">
                    <div style={{ height: "600px", width: "30%", backgroundColor: "white", float: "left" }} className = "col-sm-4 col-md-4 col-lg-4">
